...
const HistorySidebar: React.FC<HistorySidebarProps> = ({ history, isOpen, onClose, onSelect, onDelete }) => {
  ...
  return (
    <div className="fixed inset-y-0 right-0 w-80 bg-mw-black border-l border-mw-slate/30 shadow-2xl z-50 transform transition-transform duration-300 ease-in-out flex flex-col">
